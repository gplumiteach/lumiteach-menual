...
const articleTemplates = {
  ...
  'edit-lesson-add-activity': ['1.3.', 'Lesson 만들고 관리하기 / Edit Lesson 사용하기', '3. Activity 추가하기', 'Activity는 Lesson을 구성하는 슬라이드 단위의 활동입니다.', 'Activity를 추가하는 방법은 + Manual과 ✦ With AI 두 가지입니다.', ['방법 1. + Manual로 추가하기', '방법 2. ✦ With AI로 추가하기']],
  ...
  'edit-lesson-ai-make': ['1.5.', 'Lesson 만들고 관리하기 / Edit Lesson 사용하기', '5. With AI로 Activity 추가하기', '✦ With AI는 파일을 업로드하면 AI가 자동으로 Activity를 생성해주는 기능입니다.', '파일은 로컬 파일과 Google Drive 두 가지 방식으로 가져올 수 있습니다.', ['방법 1. 로컬 파일로 With AI 사용하기', '방법 2. Google Drive로 With AI 사용하기']],
...
Object.assign(articleBodies, {
  ...
  'group-start-setup': [
    ...
    'AI Credit 탭에서는 현재 플랜과 남은 크레딧, 사용 이력을 확인할 수 있습니다. With AI처럼 크레딧을 사용하는 기능을 자주 쓴다면 이 화면에서 남은 크레딧과 충전 예정일을 함께 확인하세요.'
  ],
  'setting-open': [
  ...
  'group-edit-lesson': [
    ...
    '기존 자료를 재사용하거나 With AI로 Activity를 생성할 수도 있습니다. My Storage에서 다른 Lesson을 불러오면 이미 만든 Activity를 현재 Lesson에 추가할 수 있고, With AI는 업로드한 파일을 바탕으로 Activity 초안을 만들어줍니다.',
...
const articleIntros = {
  ...
  'edit-lesson-ai-make': '**✦ With AI**는 파일을 업로드하면 AI가 자동으로 Activity를 생성해주는 기능입니다. 수업 자료(PDF, PPT 등)를 바탕으로 Full Lesson, Quiz, Discussion 등 원하는 유형의 Activity를 빠르게 만들 수 있어, 수업 준비 시간을 크게 단축할 수 있습니다.\n\n파일은 **로컬 파일(From File)**과 **Google Drive** 두 가지 방식으로 가져올 수 있습니다.',
...
Object.assign(articleBodies, {
  ...
  'edit-lesson-create': [
    'LumiTeach에 접속하면 상단 네비게이션 바에 **Create** 버튼과 **Start Teaching** 버튼이 표시됩니다. 신규 Lesson을 만들려면 상단의 **Create** 버튼을 클릭합니다.\n\n[[image:edit-lesson-create/01.png|Home 화면 상단의 Create 버튼]]\n\n**Create** 버튼을 클릭하면 Edit Lesson 화면으로 이동합니다. 처음 진입했을 때는 Activity가 없는 빈 상태로 시작되며, 화면 중앙에 "Click the button to create the first activity."라는 안내 문구와 함께 **+ Manual**, **✦ With AI** 두 가지 버튼이 표시됩니다.\n\n[[image:edit-lesson-create/02.png|빈 Edit Lesson 화면의 + Manual 및 With AI 버튼]]\n\n- **+ Manual**: 직접 Activity 유형을 선택해 수동으로 추가합니다.\n- **✦ With AI**: AI가 자동으로 Activity를 생성해줍니다.\n\n원하는 방식으로 Activity를 추가하여 Lesson을 구성하세요.',
...
Object.assign(articleBodies, {
  ...
  "class-assignment-report": [
    ...
    "[[image:class-assignment-report/01.png|Share Assignment 창]]\n\n과제를 학생에게 공유할 때는 **Share Assignment** 창을 사용합니다. 과제명과 **Due Date**, 응시 **URL**(예: `https://lumiteach.ai/student?code=5566`), **Copy Link**, **QR Code**, **Access Code**(예: 5566)를 제공합니다.",
...
const hubDescriptions = {
  ...
  'edit-lesson-add-activity': '+ Manual과 With AI를 구분해 Activity를 추가하는 방법을 확인합니다. Activity 유형을 선택하고 추가 후 편집 화면으로 이어지는 흐름을 다룹니다.',
...
Object.assign(hubDescriptions, {
  'cat-toolkit': 'Teaching 화면에서 수업 중 바로 사용할 수 있는 보조 도구를 확인합니다.',
  'group-toolkit-normal': '수업 중 자주 쓰는 기본 보조 도구를 확인합니다.',
  'group-toolkit-timer': '수업 시간과 활동 시간을 관리하는 타이머 도구를 확인합니다.',
  'group-toolkit-competition': '학생 참여를 높이는 경쟁형 도구를 확인합니다.',
  'group-toolkit-draw': '발표자 선정과 역할 배정에 활용할 수 있는 추첨 도구를 확인합니다.',
  'group-toolkit-math-tools': '수업 화면 위에 띄워 사용하는 수학 보조 도구를 확인합니다.',
  'toolkit-wheel': '입력한 항목 중 하나를 무작위로 뽑아 학생 호명이나 발표 순서 정하기에 활용할 수 있습니다.',
  'toolkit-dice': '주사위를 굴려 무작위 숫자를 얻고 게임 활동이나 간단한 추첨에 활용할 수 있습니다.',
  'toolkit-bell': '메시지와 종소리로 학생들의 주의를 집중시킬 수 있습니다.',
  'toolkit-sound-monitor': '교실 소음 수준이나 발표자 목소리 크기를 실시간으로 확인할 수 있습니다.',
  'toolkit-clock': '현재 날짜와 시간을 디지털 또는 아날로그 시계로 표시할 수 있습니다.',
  'toolkit-annotate': '수업 화면에 메모나 강조할 내용을 크게 표시하고 저장할 수 있습니다.',
  'toolkit-share-web-link': '수업 중 학생 화면으로 웹 링크를 전송하고 참고 자료나 외부 사이트를 바로 공유할 수 있습니다.',
  'toolkit-quick-quiz': '수업 중 즉석에서 객관식 또는 주관식 퀴즈를 만들어 출제할 수 있습니다.',
  'toolkit-quick-poll': '간단한 질문을 던지고 학생들의 응답을 즉석에서 집계할 수 있습니다.',
  'toolkit-digital-timer': '설정한 시간을 숫자로 표시하며 카운트다운할 수 있습니다.',
  'toolkit-hourglass': '모래시계 애니메이션으로 남은 시간을 직관적으로 보여줄 수 있습니다.',
  'toolkit-pie-timer': '원형 다이얼의 색상 변화로 남은 시간을 보여줄 수 있습니다.',
  'toolkit-first-to-buzz': '학생들이 버튼을 누르는 속도를 겨루는 순발력 게임을 진행할 수 있습니다.',
  'toolkit-presentation-lottery': '발표자나 순서를 무작위로 정하는 추첨을 진행할 수 있습니다.',
  'toolkit-card-draw': '카드를 뽑는 방식으로 학생이나 항목을 무작위 선택할 수 있습니다.',
  'toolkit-lucky-ladder': '사다리 타기 방식으로 학생이나 항목을 무작위 매칭할 수 있습니다.',
  'toolkit-group-maker': '학생 명단을 바탕으로 그룹을 자동으로 만들 수 있습니다.',
  'toolkit-ruler': '화면 위에 자를 띄워 길이를 재거나 설명할 수 있습니다.',
  'toolkit-triangle': '삼각자를 화면 위에 띄워 선과 각도를 설명할 수 있습니다.',
  'toolkit-protractor': '각도기를 화면 위에 띄워 각도를 측정하거나 설명할 수 있습니다.'
});
...
const hubVisuals = {
  ...
  'cat-start': { icon: 'Setting', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'gear-six', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff' },
  'setting-open': { icon: 'Setting', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'sliders-horizontal', bg: 'linear-gradient(135deg, #eaf1ff, #f7f7f6)', color: '#204cff' },
  'setting-profile': { icon: 'Profile', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'user-circle-gear', bg: 'linear-gradient(135deg, #eaf7f0, #eaf1ff)', color: '#0f7f78' },
  'setting-language': { icon: 'Language', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'translate', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'setting-curriculum': { icon: 'K-12', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78', size: '24px' },
  'setting-ai-credit': { icon: 'AI Credit', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'sparkle', bg: 'linear-gradient(135deg, #fff1df, #f6f9ff)', color: '#204cff' },
  'group-edit-lesson': { icon: 'Edit Lesson', iconLibrary: 'phosphor', iconType: 'pencil-simple-line', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78' },
  ...
  'group-lesson-idea-board-activity': { icon: 'Idea Board', iconType: 'idea-board', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#204cff', size: '34px' },
  'cat-assignment': { icon: 'Assignment', iconType: 'assignment', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '34px' },
  'group-edit-lesson-self-study': { icon: 'Self Study', iconType: 'self-study', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'group-assessment-run': { icon: 'Assessment', iconType: 'assessment', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '30px' },
  ...
  'edit-lesson-create': { icon: 'Create', iconLibrary: 'phosphor', iconType: 'plus', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78' },
  'edit-lesson-rename': { icon: 'Rename', iconLibrary: 'phosphor', iconType: 'text-aa', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff', size: '32px' },
  'edit-lesson-add-activity': { icon: 'Activity', iconLibrary: 'phosphor', iconType: 'squares-four', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78' },
  'edit-lesson-load-storage': { icon: 'Load Storage', iconLibrary: 'phosphor', iconType: 'tray-arrow-down', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'edit-lesson-ai-make': { icon: 'With AI', iconLibrary: 'phosphor', iconType: 'sparkle', bg: 'linear-gradient(135deg, #ffb15f, #4f78ff 55%, #5aa2ff)', color: '#fff', size: '30px' },
  'edit-lesson-interaction': { icon: 'Interaction', iconLibrary: 'phosphor', iconType: 'users-three', bg: 'linear-gradient(135deg, #e2ebff, #f6f9ff)', color: '#204cff' },
  'edit-lesson-presentation': { icon: 'Presentation', iconLibrary: 'phosphor', iconType: 'presentation-chart', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f' },
  'edit-lesson-undo-redo': { icon: 'Undo Redo', iconLibrary: 'phosphor', iconType: 'arrow-counter-clockwise', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff' },
  'edit-lesson-preview': { icon: 'Preview', iconLibrary: 'phosphor', iconType: 'eye', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#1f2740' },
  'edit-lesson-background-color': { icon: 'Background Color', iconLibrary: 'phosphor', iconType: 'paint-bucket', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#f0a13d' },
  'edit-lesson-background-image': { icon: 'Background Image', iconLibrary: 'phosphor', iconType: 'image-square', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#2563e9' },
  'edit-lesson-activity-common-setting': { icon: 'Common Setting', iconLibrary: 'phosphor', iconType: 'gear-six', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78' },
  ...
  'edit-lesson-rewrite': { icon: 'Rewrite', iconType: 'rewrite', bg: 'linear-gradient(135deg, #e2ebff, #f6f9ff)', color: '#204cff' },
  ...
  'edit-lesson-webviewer': { icon: 'Browser', iconType: 'browser', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '36px' },
  'edit-lesson-youtube': { icon: 'Play', iconType: 'play', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f', size: '34px' },
  'edit-lesson-document': { icon: 'Document', iconType: 'document', bg: 'linear-gradient(135deg, #eaf1ff, #f7f7f6)', color: '#233a78', size: '36px' },
  'edit-lesson-sound': { icon: '♪', bg: 'linear-gradient(135deg, #f6f9ff, #eaf1ff)', color: '#204cff' },
  'edit-lesson-quiz-true-false': { icon: 'True or False', iconType: 'true-false', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '26px' },
  'edit-lesson-quiz-multiple-choice': { icon: 'Multiple Choice', iconType: 'multiple-choice', bg: 'linear-gradient(135deg, #eaf1ff, #f7f7f6)', color: '#233a78', size: '30px' },
  'edit-lesson-quiz-short-answer': { icon: 'Short Answer', iconType: 'short-answer', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff', size: '30px' },
  'edit-lesson-quiz-fill-blank': { icon: '_', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'edit-lesson-quiz-matching': { icon: 'Matching', iconType: 'matching', bg: 'linear-gradient(135deg, #e2ebff, #f6f9ff)', color: '#204cff' },
  'edit-lesson-quiz-open-ended': { icon: 'Open Ended', iconType: 'open-ended', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f', size: '30px' },
  'edit-lesson-quiz-sequencing': { icon: 'Sequencing', iconType: 'sequencing', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'edit-lesson-quiz-sorting': { icon: '⇅', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78' },
  'edit-lesson-discussion-agree-disagree': { icon: 'Agree Disagree', iconType: 'agree-disagree', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '26px' },
  'edit-lesson-discussion-opinion-scale': { icon: 'Opinion Scale', iconType: 'opinion-scale', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '26px' },
  'edit-lesson-discussion-traffic-light': { icon: 'Traffic Light', iconType: 'traffic-light', bg: 'linear-gradient(135deg, #fff7df, #e9fff6)', color: '#0f7f78', size: '30px' },
  'edit-lesson-discussion-vote': { icon: 'Vote', iconType: 'vote', bg: 'linear-gradient(135deg, #f6f9ff, #eaf1ff)', color: '#204cff' },
  'edit-lesson-idea-board-brainstorming': { icon: 'Brainstorming', iconType: 'brainstorm', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '34px' },
  'edit-lesson-idea-board-whiteboard': { icon: 'Whiteboard', iconType: 'whiteboard', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#204cff', size: '34px' },
  'assessment-create': { icon: 'Assessment', iconType: 'assessment', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '30px' },
...
const hubCovers = {
  ...
  'group-lesson-quiz-activity': { icon: '?', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78' },
  'group-lesson-discussion-activity': { icon: '…', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f' },
  'cat-assignment': { icon: 'Assignment', iconType: 'assignment', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '52px' },
  'group-edit-lesson-self-study': { icon: 'Self Study', iconType: 'self-study', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '52px' },
  'group-assessment-run': { icon: 'Assessment', iconType: 'assessment', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '52px' }
};
...
Object.assign(hubVisuals, {
  'cat-explore': { icon: 'Creator Page', iconType: 'creator', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'explore-browse': { icon: '⌕', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '42px' },
  'explore-creator-page': { icon: 'Creator Page', iconType: 'creator', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78', size: '34px' }
});

Object.assign(hubVisuals, {
  'cat-storage': { icon: 'Storage', iconType: 'storage', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'storage-overview': { icon: 'Storage', iconType: 'storage', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
...
Object.assign(hubCovers, {
  'cat-explore': { icon: 'Creator Page', iconType: 'creator', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  'explore-creator-page': { icon: 'Creator Page', iconType: 'creator', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78', size: '50px' },
...
Object.assign(hubCovers, {
  'cat-storage': { icon: 'Storage', iconType: 'storage', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  'storage-overview': { icon: 'Storage', iconType: 'storage', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
...
Object.assign(hubVisuals, {
  'cat-class': { icon: 'Class', iconType: 'class', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'class-teaching-report': { icon: 'Teaching Report', iconType: 'teaching-report', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '34px' },
  'class-assignment-report': { icon: 'Assignment Report', iconType: 'assignment-report', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'class-management': { icon: 'Class Management', iconType: 'class-management', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78', size: '34px' }
});

Object.assign(hubCovers, {
  'cat-class': { icon: 'Class', iconType: 'class', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '54px' },
  'class-teaching-report': { icon: 'Teaching Report', iconType: 'teaching-report', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '54px' },
  'class-assignment-report': { icon: 'Assignment Report', iconType: 'assignment-report', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#204cff', size: '54px' },
  'class-management': { icon: 'Class Management', iconType: 'class-management', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78', size: '54px' }
});
...
// BEGIN FINAL PHOSPHOR FILL ICON PATCH
Object.assign(hubVisuals, {
  'group-intro-service': { icon: 'LT', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chalkboard-teacher', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'group-intro-basics': { icon: 'ABC', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'books', bg: 'linear-gradient(135deg, #fff4df, #f6f9ff)', color: '#244c7d', size: '24px' },
  'setting-curriculum': { icon: 'K-12', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'graduation-cap', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78', size: '24px' },
  'group-lesson-material-edit': { icon: 'Aa', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'text-aa', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff', size: '32px' },
  'group-lesson-embed': { icon: '<>', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'code', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '30px' },
  'group-lesson-quiz-activity': { icon: '?', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'question', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78' },
  'group-lesson-discussion-activity': { icon: '…', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chats-circle', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f' },
  'group-lesson-idea-board-activity': { icon: 'Idea Board', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'lightbulb', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#204cff', size: '34px' },
  'cat-assignment': { icon: 'Assignment', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clipboard-text', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '34px' },
  'group-edit-lesson-self-study': { icon: 'Self Study', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'book-open-user', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'group-assessment-run': { icon: 'Assessment', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'exam', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '30px' },
  'group-teaching-mode': { icon: '▶', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'monitor-play', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f' },
  'group-reports-results': { icon: 'Σ', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chart-bar', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78' },
  'edit-lesson-self-study-individual': { icon: 'I', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'book-open-user', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78' },
  'edit-lesson-self-study-challenge': { icon: 'C', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'trophy', bg: 'linear-gradient(135deg, #fff1df, #ffe6ef)', color: '#d85f4f' },
  'edit-lesson-self-study-flash-card': { icon: 'FC', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cards', bg: 'linear-gradient(135deg, #f6f9ff, #eaf1ff)', color: '#204cff', size: '30px' },
  'edit-lesson-text-properties': { icon: 'T', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'text-aa', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff' },
  'edit-lesson-rewrite': { icon: 'Rewrite', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'magic-wand', bg: 'linear-gradient(135deg, #e2ebff, #f6f9ff)', color: '#204cff' },
  'edit-lesson-add-text-object': { icon: 'T+', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cursor-text', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '30px' },
  'edit-lesson-add-shape': { icon: '□', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'intersect-square', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#204cff' },
  'edit-lesson-upload-image': { icon: '↑', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'file-arrow-up', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'edit-lesson-image-properties': { icon: '▧', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'image-square', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f' },
  'edit-lesson-webviewer': { icon: 'Browser', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'browser', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '36px' },
  'edit-lesson-youtube': { icon: 'Play', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'play', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f', size: '34px' },
  'edit-lesson-document': { icon: 'Document', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'file-text', bg: 'linear-gradient(135deg, #eaf1ff, #f7f7f6)', color: '#233a78', size: '36px' },
  'edit-lesson-sound': { icon: '♪', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'file-audio', bg: 'linear-gradient(135deg, #f6f9ff, #eaf1ff)', color: '#204cff' },
  'edit-lesson-quiz-true-false': { icon: 'True or False', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'check-square', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '26px' },
  'edit-lesson-quiz-multiple-choice': { icon: 'Multiple Choice', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'list-checks', bg: 'linear-gradient(135deg, #eaf1ff, #f7f7f6)', color: '#233a78', size: '30px' },
  'edit-lesson-quiz-short-answer': { icon: 'Short Answer', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chat-circle-text', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff', size: '30px' },
  'edit-lesson-quiz-fill-blank': { icon: '_', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cursor-text', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'edit-lesson-quiz-matching': { icon: 'Matching', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'arrows-down-up', bg: 'linear-gradient(135deg, #e2ebff, #f6f9ff)', color: '#204cff' },
  'edit-lesson-quiz-open-ended': { icon: 'Open Ended', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chats-circle', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f', size: '30px' },
  'edit-lesson-quiz-sequencing': { icon: 'Sequencing', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'list-numbers', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'edit-lesson-quiz-sorting': { icon: '⇅', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'arrows-down-up', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78' },
  'edit-lesson-discussion-agree-disagree': { icon: 'Agree Disagree', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'check-square', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '26px' },
  'edit-lesson-discussion-opinion-scale': { icon: 'Opinion Scale', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'sliders-horizontal', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '26px' },
  'edit-lesson-discussion-traffic-light': { icon: 'Traffic Light', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'circles-three', bg: 'linear-gradient(135deg, #fff7df, #e9fff6)', color: '#0f7f78', size: '30px' },
  'edit-lesson-discussion-vote': { icon: 'Vote', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'check-square', bg: 'linear-gradient(135deg, #f6f9ff, #eaf1ff)', color: '#204cff' },
  'edit-lesson-idea-board-brainstorming': { icon: 'Brainstorming', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'brain', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '34px' },
  'edit-lesson-idea-board-whiteboard': { icon: 'Whiteboard', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chalkboard', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#204cff', size: '34px' },
  'assessment-create': { icon: 'Assessment', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'exam', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '30px' },
  'assessment-questions': { icon: 'Q', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'question', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78' },
  'assessment-distribute': { icon: '↗', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'arrow-square-up', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9' },
  'assessment-results': { icon: '✓', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'check-circle', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78' },
  'cat-toolkit': { icon: 'TK', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'gear-six', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'group-toolkit-normal': { icon: '⭐', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'star', bg: 'linear-gradient(135deg, #eaf1ff, #fff7df)', color: '#204cff' },
  'group-toolkit-timer': { icon: '⏱', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clock-countdown', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#2563e9' },
  'group-toolkit-competition': { icon: '🏆', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'trophy', bg: 'linear-gradient(135deg, #fff1df, #ffe6ef)', color: '#d85f4f' },
  'group-toolkit-draw': { icon: '🎴', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cards', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78' },
  'group-toolkit-math-tools': { icon: '📐', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'calculator', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78' },
  'toolkit-wheel': { icon: '◌', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'circle-notch', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-dice': { icon: '⚂', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'dice-five', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-bell': { icon: '🔔', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'bell-ringing', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-sound-monitor': { icon: 'dB', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'gauge', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-clock': { icon: '🕒', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clock', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-annotate': { icon: 'Aa', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'note-pencil', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-share-web-link': { icon: '🔗', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'link-simple', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-quick-quiz': { icon: 'Q', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'question', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-quick-poll': { icon: 'P', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chart-pie-slice', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-digital-timer': { icon: '00', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clock-countdown', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-hourglass': { icon: '⌛', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'hourglass', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-pie-timer': { icon: '◔', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chart-pie-slice', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-first-to-buzz': { icon: '⚡', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'lightning', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-presentation-lottery': { icon: '🎫', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'ticket', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-card-draw': { icon: '🂠', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cards', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-lucky-ladder': { icon: '⇄', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'ladder', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-group-maker': { icon: '👥', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'users-three', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '28px' },
  'toolkit-ruler': { icon: '▭', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'ruler', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-triangle': { icon: '△', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'triangle', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'toolkit-protractor': { icon: '∠', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'angle', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'cat-explore': { icon: 'Creator Page', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'identification-card', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'explore-browse': { icon: '⌕', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'magnifying-glass', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '42px' },
  'explore-creator-page': { icon: 'Creator Page', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'identification-card', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78', size: '34px' },
  'cat-storage': { icon: 'Storage', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'folders', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  'storage-overview': { icon: 'Storage', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'folders', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '30px' },
  ...
  'class-assignment-report': { icon: 'Assignment Report', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clipboard-text', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#204cff', size: '34px' },
  'class-management': { icon: 'Class Management', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'user-circle-gear', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78', size: '34px' }
});

Object.assign(hubCovers, {
  'setting-curriculum': { icon: 'K-12', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'graduation-cap', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78', size: '40px' },
  'cat-lesson': { icon: '✎', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'pencil-simple-line', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78' },
  'group-lesson-material-edit': { icon: 'Aa', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'text-aa', bg: 'linear-gradient(135deg, #fff1d8, #f6f9ff)', color: '#204cff', size: '48px' },
  'group-lesson-embed': { icon: '<>', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'code', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '46px' },
  'group-lesson-quiz-activity': { icon: '?', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'question', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#233a78' },
  'group-lesson-discussion-activity': { icon: '…', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'chats-circle', bg: 'linear-gradient(135deg, #fff0df, #ffe6ef)', color: '#d85f4f' },
  'cat-assignment': { icon: 'Assignment', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clipboard-text', bg: 'linear-gradient(135deg, #e6f0ff, #fff7df)', color: '#2563e9', size: '52px' },
  'group-edit-lesson-self-study': { icon: 'Self Study', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'book-open-user', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '52px' },
  'group-assessment-run': { icon: 'Assessment', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'exam', bg: 'linear-gradient(135deg, #fff1df, #f7efe6)', color: '#d85f4f', size: '52px' },
  'cat-explore': { icon: 'Creator Page', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'identification-card', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  'explore-creator-page': { icon: 'Creator Page', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'identification-card', bg: 'linear-gradient(135deg, #e8f4ff, #dff7ef)', color: '#0f7f78', size: '50px' },
  'cat-toolkit': { icon: 'TK', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'gear-six', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  'group-toolkit-normal': { icon: '⭐', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'star', bg: 'linear-gradient(135deg, #eaf1ff, #fff7df)', color: '#204cff', size: '44px' },
  'group-toolkit-timer': { icon: '⏱', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clock-countdown', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#2563e9', size: '44px' },
  'group-toolkit-competition': { icon: '🏆', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'trophy', bg: 'linear-gradient(135deg, #fff1df, #ffe6ef)', color: '#d85f4f', size: '44px' },
  'group-toolkit-draw': { icon: '🎴', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'cards', bg: 'linear-gradient(135deg, #eaf1ff, #e9fff6)', color: '#0f7f78', size: '44px' },
  'group-toolkit-math-tools': { icon: '📐', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'calculator', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78', size: '44px' },
  'cat-storage': { icon: 'Storage', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'folders', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  'storage-overview': { icon: 'Storage', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'folders', bg: 'linear-gradient(135deg, #eaf1ff, #f6f9ff)', color: '#204cff', size: '50px' },
  ...
  'class-assignment-report': { icon: 'Assignment Report', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'clipboard-text', bg: 'linear-gradient(135deg, #e6f0ff, #f6f9ff)', color: '#204cff', size: '54px' },
  'class-management': { icon: 'Class Management', iconLibrary: 'phosphor', iconWeight: 'fill', iconType: 'user-circle-gear', bg: 'linear-gradient(135deg, #f7f7f6, #eaf1ff)', color: '#233a78', size: '54px' }
});
// END FINAL PHOSPHOR FILL ICON PATCH

// BEGIN LOCAL SVG ICON PATH PATCH
const hubIconPaths = {
  'group-intro-service': 'icon/illustration/name=Lessons, Tone=Color.svg',
  'group-intro-basics': 'icon/illustration/name=Book, Tone=Color.svg',
  'cat-start': 'icon/illustration/name=setting, Tone=Color.svg',
  'setting-open': 'icon/System/name=settings.svg',
  'setting-profile': 'icon/illustration/name=human, Tone=Color.svg',
  'setting-language': 'icon/System/name=CountrySetting.svg',
  'setting-curriculum': 'icon/System/name=curriculumDetails.svg',
  'setting-ai-credit': 'icon/System/name=AI-generated.svg',
  'cat-lesson': 'icon/illustration/name=Lessons, Tone=Color.svg',
  'group-edit-lesson': 'icon/illustration/name=Edit, Tone=Color.svg',
  'group-lesson-material-edit': 'icon/Activity/Style=Illustration, Name=material, Tone=Color.svg',
  'group-lesson-embed': 'icon/Activity/Style=line, Name=embed, Tone=Mono.svg',
  'group-lesson-quiz-activity': 'icon/Activity/Style=line, Name=Quiz, Tone=Mono.svg',
  'group-lesson-discussion-activity': 'icon/Activity/Style=line, Name=Discussion, Tone=Mono.svg',
  'group-lesson-idea-board-activity': 'icon/Activity/Style=line, Name=IdeaBoard, Tone=Mono.svg',
  'cat-assignment': 'icon/System/name=Share.svg',
  'group-edit-lesson-self-study': 'icon/System/name=Individual.svg',
  'group-assessment-run': 'icon/illustration/name=Assessment, Tone=Color.svg',
  'group-teaching-mode': 'icon/illustration/name=StartLesson, Tone=Color.svg',
  'group-reports-results': 'icon/System/name=report.svg',
  'edit-lesson-create': 'icon/System/name=makelesson.svg',
  'edit-lesson-rename': 'icon/System/name=rename.svg',
  'edit-lesson-add-activity': 'icon/System/name=activity.svg',
  'edit-lesson-load-storage': 'icon/System/name=folder_opened.svg',
  'edit-lesson-ai-make': 'icon/System/name=AI-generated2.svg',
  'edit-lesson-interaction': 'icon/System/name=Interaction.svg',
  'edit-lesson-presentation': 'icon/System/name=Presentation.svg',
  'edit-lesson-undo-redo': 'icon/Edit Tool/name=undo.svg',
  'edit-lesson-preview': 'icon/System/name=preview.svg',
  'edit-lesson-background-color': 'icon/Edit Tool/name=bgColor.svg',
  'edit-lesson-background-image': 'icon/Edit Tool/name=image.svg',
  'edit-lesson-activity-common-setting': 'icon/System/name=settings.svg',
  'edit-lesson-self-study-individual': 'icon/System/name=Individual.svg',
  'edit-lesson-self-study-challenge': 'icon/System/name=Challenge.svg',
  'edit-lesson-self-study-flash-card': 'icon/System/name=FlashCard.svg',
  'edit-lesson-text-properties': 'icon/Edit Tool/name=textstyle.svg',
  'edit-lesson-rewrite': 'icon/System/name=AI-generated.svg',
  'edit-lesson-add-text-object': 'icon/Edit Tool/name=text.svg',
  'edit-lesson-add-shape': 'icon/Edit Tool/name=shape.svg',
  'edit-lesson-upload-image': 'icon/System/name=upload.svg',
  'edit-lesson-image-properties': 'icon/Edit Tool/name=image.svg',
  'edit-lesson-webviewer': 'icon/Activity/Style=Illustration, Name=web, Tone=Color.svg',
  'edit-lesson-youtube': 'icon/Activity/Style=Illustration, Name=Youtube, Tone=Color.svg',
  'edit-lesson-document': 'icon/Activity/Style=Illustration, Name=Document, Tone=Color.svg',
  'edit-lesson-sound': 'icon/Activity/Style=Illustration, Name=Sound, Tone=Color.svg',
  'edit-lesson-quiz-true-false': 'icon/Activity/Style=Illustration, Name=TrueFalse, Tone=Color.svg',
  'edit-lesson-quiz-multiple-choice': 'icon/Activity/Style=Illustration, Name=multiplechoice, Tone=Color.svg',
  'edit-lesson-quiz-short-answer': 'icon/Activity/Style=Illustration, Name=ShortAnswer, Tone=Color.svg',
  'edit-lesson-quiz-fill-blank': 'icon/Activity/Style=Illustration, Name=FillInTheBlank, Tone=Color.svg',
  'edit-lesson-quiz-matching': 'icon/Activity/Style=Illustration, Name=Matching, Tone=Color.svg',
  'edit-lesson-quiz-open-ended': 'icon/Activity/Style=Illustration, Name=OpenEnded, Tone=Color.svg',
  'edit-lesson-quiz-sequencing': 'icon/Activity/Style=Illustration, Name=Sequencing, Tone=Color.svg',
  'edit-lesson-quiz-sorting': 'icon/Activity/Style=Illustration, Name=Sorting, Tone=Color.svg',
  'edit-lesson-discussion-agree-disagree': 'icon/Activity/Style=Illustration, Name=AgreeDisagree, Tone=Color.svg',
  'edit-lesson-discussion-opinion-scale': 'icon/Activity/Style=Illustration, Name=OpinionScale, Tone=Color.svg',
  'edit-lesson-discussion-traffic-light': 'icon/Activity/Style=Illustration, Name=TrafficLight, Tone=Color.svg',
  'edit-lesson-discussion-vote': 'icon/Activity/Style=Illustration, Name=Vote, Tone=Color.svg',
  'edit-lesson-idea-board-brainstorming': 'icon/Activity/Style=Illustration, Name=brainstorming, Tone=Color.svg',
  'edit-lesson-idea-board-whiteboard': 'icon/Activity/Style=Illustration, Name=whiteboard, Tone=Color.svg',
  'assessment-create': 'icon/illustration/name=Assessment, Tone=Color.svg',
  'assessment-questions': 'icon/System/name=answer.svg',
  'assessment-distribute': 'icon/System/name=Share.svg',
  'assessment-results': 'icon/System/name=report.svg',
  'cat-toolkit': 'icon/Toolkit/Name=ToolkitMode.svg',
  'group-toolkit-normal': 'icon/Toolkit/Name=ToolkitMode.svg',
  'group-toolkit-timer': 'icon/Toolkit/Name=timer.svg',
  'group-toolkit-competition': 'icon/Toolkit/Name=Buzzer.svg',
  'group-toolkit-draw': 'icon/Toolkit/Name=CardDraw.svg',
  'group-toolkit-math-tools': 'icon/Toolkit/Name=Mathtools.svg',
  'toolkit-wheel': 'icon/Toolkit/Name=wheel.svg',
  'toolkit-dice': 'icon/Toolkit/Name=dice.svg',
  'toolkit-bell': 'icon/Toolkit/Name=bell.svg',
  'toolkit-sound-monitor': 'icon/Toolkit/Name=SoundMonitor.svg',
  'toolkit-clock': 'icon/Toolkit/Name=Clock.svg',
  'toolkit-annotate': 'icon/Toolkit/Name=Annotate.svg',
  'toolkit-share-web-link': 'icon/Toolkit/Name=ShareWeblink.svg',
  'toolkit-quick-quiz': 'icon/Activity/Style=line, Name=Quiz, Tone=Mono.svg',
  'toolkit-quick-poll': 'icon/Toolkit/Name=PieChart.svg',
  'toolkit-digital-timer': 'icon/Toolkit/Name=DigitalTimer.svg',
  'toolkit-hourglass': 'icon/Toolkit/Name=Hourglass.svg',
  'toolkit-pie-timer': 'icon/Toolkit/Name=PieTimer.svg',
  'toolkit-first-to-buzz': 'icon/Toolkit/Name=Buzzer.svg',
  'toolkit-presentation-lottery': 'icon/Toolkit/Name=Lottery.svg',
  'toolkit-card-draw': 'icon/Toolkit/Name=CardDraw.svg',
  'toolkit-lucky-ladder': 'icon/Toolkit/Name=LuckyLadder.svg',
  'toolkit-group-maker': 'icon/Toolkit/Name=GroupMaker.svg',
  'toolkit-ruler': 'icon/Toolkit/Name=Ruler.svg',
  'toolkit-triangle': 'icon/Toolkit/Name=Triangle.svg',
  'toolkit-protractor': 'icon/Toolkit/Name=Protractor.svg',
  'cat-explore': 'icon/illustration/name=globe, Tone=Color.svg',
  'explore-browse': 'icon/System/name=search.svg',
  'explore-creator-page': 'icon/illustration/name=human, Tone=Color.svg',
  'cat-storage': 'icon/illustration/name=Storage, Tone=Color.svg',
  'storage-overview': 'icon/illustration/name=Storage, Tone=Color.svg',
  ...
  'class-assignment-report': 'icon/illustration/name=WorkSheet, Tone=Color.svg',
  'class-management': 'icon/System/name=Group.svg'
};

Object.entries(hubIconPaths).forEach(([key, iconPath]) => {
  if (hubVisuals[key]) {
    Object.assign(hubVisuals[key], { iconPath });
  }
  if (hubCovers[key]) {
    Object.assign(hubCovers[key], { iconPath });
  }
});
// END LOCAL SVG ICON PATH PATCH
